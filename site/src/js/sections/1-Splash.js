    ...
    <div className="flex justify-center bg-blue">
      <div className="grid12 ph4 ph8-ns pt9 pb10">
        ...
        <div className="c7-10-lg c9-13-md mt6 c1-7 mt0-ns">
          <h4 className="white mb2 fw-bold">Utilities</h4>
          <Link>Border </Link>
          <Link>Debug</Link>
          <Link>Display</Link>
          <Link>Flexbox</Link>
        ...
        <div className="c10-13-lg c1-5-md mt6 mt0-ns c7-13">
          <h4 className="white mb2 fw-bold">Components</h4>
          <Link>Button</Link>
